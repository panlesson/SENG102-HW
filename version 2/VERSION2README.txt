...
Obviously we do not have access to neither the hardware of the said device or a library database, so the program is written to behave 'as if' it was actually installed within the place. While scanning items you will simply be asked to enter a number to imitate scanning an item.
